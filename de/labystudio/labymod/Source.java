...
public class Source
{
  ...
  public static String mod_VersionName = "2.7.78";
  public static int mod_VersionId = 15;
  ...
  public static String url_serverIP = "mod.labymod.net";
  ...
  public static String url_cape_labymod = "http://capes.labymod.net/capes/";
  public static final String url_user_capes = "http://info.labymod.net/php/userCapes.json";
  public static final String url_mod_info = "http://info.labymod.net/php/modInfo.php?ver=" + mcVersion;
  public static String url_changeCape = "http://info.labymod.net/php/changeCape.php";
  public static String url_moveCape = "http://info.labymod.net/php/moveCape.php";
