...
public class blq
  extends blx
{
  private static final kk a = new kk("textures/entity/explosion.png");
  ...
  protected blq(bvi ☃, aht ☃, double ☃, double ☃, double ☃, double ☃, double ☃, double ☃)
  {
    super(☃, ☃, ☃, ☃, 0.0D, 0.0D, 0.0D);
    this.J = ☃;
    this.I = (6 + this.p.nextInt(4));
  ...
  public void a(bmz ☃, rr ☃, float ☃, float ☃, float ☃, float ☃, float ☃, float ☃)
  {
    ...
    ☃.a(7, G);
    ☃.b(☃ - ☃ * ☃ - ☃ * ☃, ☃ - ☃ * ☃, ☃ - ☃ * ☃ - ☃ * ☃).a(☃, ☃).a(this.y, this.z, this.A, 1.0F).a(0, 240).c(0.0F, 1.0F, 0.0F).d();
    ☃.b(☃ - ☃ * ☃ + ☃ * ☃, ☃ + ☃ * ☃, ☃ - ☃ * ☃ + ☃ * ☃).a(☃, ☃).a(this.y, this.z, this.A, 1.0F).a(0, 240).c(0.0F, 1.0F, 0.0F).d();
    ☃.b(☃ + ☃ * ☃ + ☃ * ☃, ☃ + ☃ * ☃, ☃ + ☃ * ☃ + ☃ * ☃).a(☃, ☃).a(this.y, this.z, this.A, 1.0F).a(0, 240).c(0.0F, 1.0F, 0.0F).d();
    ☃.b(☃ + ☃ * ☃ - ☃ * ☃, ☃ - ☃ * ☃, ☃ + ☃ * ☃ - ☃ * ☃).a(☃, ☃).a(this.y, this.z, this.A, 1.0F).a(0, 240).c(0.0F, 1.0F, 0.0F).d();
    bnu.a().b();
