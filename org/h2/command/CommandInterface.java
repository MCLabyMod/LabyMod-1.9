...
public abstract interface CommandInterface
{
  ...
  public static final int ALTER_TABLE_ALTER_COLUMN_NULL = 9;
  ...
  public abstract ResultInterface executeQuery(int paramInt, boolean paramBoolean);
  ...
  public abstract ResultInterface getMetaData();
}
