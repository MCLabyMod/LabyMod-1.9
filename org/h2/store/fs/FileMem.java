  ...
  extends FileBase
{
    ...
    throws IOException
  {
    ...
    this.data.touch(this.readOnly);
    this.pos = this.data.readWrite(this.pos, src.array(), src.arrayOffset() + src.position(), len, true);
    ...
    throws IOException
  {
    ...
    long newPos = this.data.readWrite(this.pos, dst.array(), dst.arrayOffset() + dst.position(), len, false);
